...
public class MyDefaultProcessDiagramCanvas extends DefaultProcessDiagramCanvas {
    //设置高亮线的颜色  这里我设置成绿色
    //定义走过流程连线颜色为红色
    protected static Color HIGHLIGHT_SequenceFlow_COLOR = new Color(14,79,79);
    //设置未走过流程的连接线颜色
    protected static Color CONNECTION_COLOR = Color.BLACK;
    //设置flows连接线字体颜色黑色
    protected static Color LABEL_COLOR = new Color(0, 0, 0);
    //高亮显示task框颜色
    protected static Color HIGHLIGHT_COLOR = HIGHLIGHT_SequenceFlow_COLOR = new Color(14,79,79);
    ...
    public void drawLabel(String text, GraphicInfo graphicInfo, boolean centered) {
        ...
        if (text != null && text.length() > 0) {
            ...
            int wrapWidth = 80;
            int textY = (int) graphicInfo.getY()-13;
