/*
此脚本对应<flowable.version>6.5.0</flowable.version>版本

Source Server         : 114.215.209.193
Source Server Version : 50720
Source Host           : 114.215.209.193:6381
Source Database       : demo_flowable

Target Server Type    : MYSQL
Target Server Version : 50720
File Encoding         : 65001

Date: 2020-08-25 18:56:28
*/
...
INSERT INTO `act_ge_property` VALUES ('schema.history', 'upgrade(6.5.0.1->6.5.0.6)', '3');
INSERT INTO `act_ge_property` VALUES ('schema.version', '6.5.0.6', '3');
...
-- ----------------------------
-- ----------------------------
-- Table structure for lg_activity_log
-- ----------------------------
DROP TABLE IF EXISTS `lg_activity_log`;
CREATE TABLE `lg_activity_log` (
...
-- ----------------------------
-- Table structure for lg_archives_doc
-- ----------------------------
DROP TABLE IF EXISTS `lg_archives_doc`;
CREATE TABLE `lg_archives_doc` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_date` datetime NOT NULL,
  `creater` varchar(30) DEFAULT NULL,
  `modifier` varchar(30) DEFAULT NULL,
  `modify_date` datetime NOT NULL,
  `archives_details` varchar(255) DEFAULT NULL,
  `archives_nature` varchar(50) DEFAULT NULL,
  `consult_term` datetime DEFAULT NULL,
...
-- ----------------------------
-- Table structure for lg_process_variables_log
-- ----------------------------
DROP TABLE IF EXISTS `lg_process_variables_log`;
CREATE TABLE `lg_process_variables_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `creater` varchar(30) DEFAULT NULL COMMENT '添加人登录名',
  `create_time` datetime DEFAULT NULL COMMENT '添加事件',
  `creater_name` varchar(100) DEFAULT NULL COMMENT '添加人',
  `title` varchar(255) DEFAULT NULL COMMENT '表单标题',
  `table_name` varchar(100) DEFAULT NULL COMMENT '表名',
  `form_id` varchar(100) DEFAULT NULL COMMENT '表单id',
  `process_instance_id` varchar(50) DEFAULT NULL COMMENT '流程id',
  `process_instance_name` varchar(255) DEFAULT NULL COMMENT '流程名称',
  `process_type` varchar(255) DEFAULT NULL COMMENT '流程类型',
